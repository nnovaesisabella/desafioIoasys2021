            ...
            <DescriptionBook>
              <ContentDescription>
                ...
                <Information>
                  ...
                  <p>
                    {' '}
                    Páginas <span>{item.pageCount} </span>
                  </p>
                  <p>
                    {' '}
                    Editora <span>{item.publisher}</span>{' '}
                  </p>
                  <p>
                    {' '}
                    Publicação <span>{item.published} </span>{' '}
                  </p>
                  <p>
                    {' '}
                    Idioma <span> {item.language}</span>{' '}
                  </p>
                  <p>
                    {' '}
                    Título Original <span>{item.title} </span>
                  </p>
                  <p>
                    {' '}
                    ISBN-10 <span> {item.isbn10}</span>
                  </p>
                  <p>
                    {' '}
                    ISBN-12 <span>{item.isbn13}</span>
                  </p>
                </Information>
                <DetailsBook>
